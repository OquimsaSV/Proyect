...
?>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <li class="nav-item bg-faded" data-toggle="tooltip" data-placement="right" title="Usuario">
          <a class="nav-link" href="usuario.php">
            ...
            <img src=
              ...
              ?>
             width='40px' height="40px" style="margin-left:-10px;" class="rounded-circle">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
            <a class="nav-link" href="Calculador/index.php">
            <i class="fa fa-fw fa-sign-out"></i>HERRAMIENTAS</a>
        </li>
